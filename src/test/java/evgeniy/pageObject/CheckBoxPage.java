...
public class CheckBoxPage {
    ...
    By checkBoxDocumentsWorkSpace= By.xpath("//span[@title='WorkSpace']/preceding-sibling::span[contains(@class,'checkbox')]");
    ...
    By checkBoxDocumentsOffice = By.xpath("//span[@title='Office']/preceding-sibling::span[contains(@class,'checkbox')]");
    ...
    public CheckBoxPage setCheckBoxDocumentsOffice() {
        WebElement element = webDriver.findElement(checkBoxDocumentsOffice);
        element.click();
        return this;
    }

    public CheckBoxPage setCheckBoxDocumentsWorkSpace() {
        WebElement element = webDriver.findElement(checkBoxDocumentsWorkSpace);
        element.click();
        return this;
    }
